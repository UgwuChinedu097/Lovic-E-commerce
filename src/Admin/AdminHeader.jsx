...
//               className="w-64 bg-white rounded-md shadow-lg p-2"
//               sideOffset={5}
//             >
...
//                     key={note.id}
//                     className={cn(
//                       "px-3 py-2 rounded-md text-sm cursor-pointer select-none text-gray-700 hover:bg-gray-100"
//                     )}
//                   >
//                     {note.text}
//                   </DropdownMenu.Item>
