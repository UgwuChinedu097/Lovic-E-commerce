...
const ProductDetail = () => {
  ...
  return (
    <>
      ...
      <section className="p-8 max-w-7xl mx-auto grid gap-10 grid-cols-1 lg:grid-cols-2">
        {/* Left: Image Viewer */}
        <div>
          <div className="flex justify-center items-center h-[400px] md:h-[500px] rounded-lg bg-gray-100 mb-4">
        ...
        <div>
          ...
          {/* Stock */}
          <p className={`mb-4 font-medium ${product.stock === 0 ? "text-red-500" : "text-gray-700"}`}>
          ...
          <div className="mb-4">
            ...
            <p className="text-lg font-semibold text-orange-600">
              ${product.price && quantity ? (product.price * quantity).toFixed(2) : "N/A"}
            </p>
          </div>
